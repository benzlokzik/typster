...
config :typster, TypsterWeb.Endpoint,
  ...
  url: [host: "127.0.0.1", port: String.to_integer(System.get_env("PORT") || "4000")],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  ...
  watchers: [
    ...
    bun_worker: {Bun, :install_and_run, [:worker, ~w(--sourcemap=inline --watch)]},
...
config :typster, TypsterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/typster_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
