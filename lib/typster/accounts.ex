defmodule Typster.Accounts do
  ...
  alias Typster.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Typster.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Typster.Accounts.User.password_changeset/3` for a list of supported options.
